...
class SaleOrder(models.Model):
    ...
    #     string="Comicion",
    #     related='accounts_payable_crm_id.commission'
    # )
    ...
    def _compute_total_cost(self):
        for order in self:
            total_cost = sum(order.order_line.mapped(lambda line: line.product_id.standard_price * line.product_uom_qty))
...
class SaleOrderCommission(models.Model):
    ...
    commission = fields.Float(string='Commission', related='account_commission_ids.commission', store=True)
